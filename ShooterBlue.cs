...
{ 
    ...
    {   
        ...
        if (YellowBuff_Trigger.YellowBuffOn==true)//if the Yellow buff was activated by the enemy on the last round
        {
            yellowBuff = true;
        ...
        if (BlueBuff_Trigger.BlueBuffOn == true) //if the Blue buff was activated by the enemy on the last round
        {
            FindObjectOfType<AudioManager>().play("Buff");
            blueBuff = true;
            this.tag = "OffBlueBall";
        ...
        if (BlackBuff_Trigger.BlackBuffBlueOn == true || BlackBuff_Trigger.BlackBuffRedOn==true)
        {
            this.tag = "OffBlueBall";
        }
